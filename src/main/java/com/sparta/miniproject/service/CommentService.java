...
public class CommentService {
    ...
    // 댓글 생성 로직 - User만 생성가능
    public Comment postComment(Long hobbyId, CommentRequestDto commentRequestDto, UserDetailsImpl userDetails) {
    ...
    // 댓글 조회 로직 - 모두 조회가능
    public List<CommentResponseDto> getComment(@PathVariable Long hobbyId) {
    ...
    @Transactional
    public void putComment(Long commentId, CommentRequestDto commentRequestDto, UserDetailsImpl userDetails){
